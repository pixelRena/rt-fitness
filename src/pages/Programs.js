		...
		<div className="container mt-5 mb-5">
			...
			<div className="row row-cols-1 row-cols-md-3 g-4 mb-5">
				<div className="col">
					<div className="card">
						<div className="card-img-top" style={{height:"200px", overflow:"hidden", backgroundColor:"lightgrey"}}>
							<img src="/images/pexels-karolina-grabowska-4397840.jpg" style={{"marginTop":"-400px"}} width="500px"/>
						</div>
				...
				<div className="col">
					<div className="card">
						<div className="card-img-top" style={{height:"200px", overflow:"hidden", backgroundColor:"lightgrey"}}>
							<img src="/images/pexels-andrea-piacquadio-3766211.jpg" width="400px"/>
						</div>
						<div className="card-body">
				...
				<div className="col">
					<div className="card">
						<div className="card-img-top" style={{height:"200px", overflow:"hidden", backgroundColor:"lightgrey"}}>
							<img src="/images/pexels-ivan-samkov-4162449.jpg" width="400px" style={{"marginTop":"-100px"}}/>
						</div>
						<div className="card-body">
