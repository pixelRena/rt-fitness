const StepOne = ({setName,setLocation,setXP,setSex,setOtherSex,name,location,sex,xp,otherSex}) => {
	return(
		<div className="mb-4">
			...
			<div className="form-check mb-3">
				...
				<input className="form-control w-50" id="other-identification" type="text" onChange={e => setOtherSex(e.target.value)}/>
			</div>
